        ...
        <table class="table-bordered" width="900px" style="text-align:center;" border="1px">
            <tr>
                ...
                <?php
                   ...
                   <td><Button class="btn" name=""><a href="edit_cat.php?aid=<?php echo $row['cat_id'];?>">Edit</a></Button><Button class="btn" name=""><a href="delete_cat.php?aid=<?php echo $row['cat_id'];?>">Delete</a></Button></td>
                   </tr>
                <?php    
                   }
                ?>
