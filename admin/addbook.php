...
<div class="row">
    ...
    <div class="col-md-4">
        <form action="add1.php" method="post">
            ...
            <input type="number" placeholder="Enter The Book Id :" name="bid" id="bid"readonly class="form-control">
            <br>
            <label >Book Name :</label>
            <input type="text" placeholder="Enter The Book Name :" name="bname" required class="form-control">
            <br>
           ...
           <br>
            ...
            <!-- <input type="text" placeholder="Enter The Category Id :" name="bcat" required class="form-control"> -->
            <br>
            <label >Book Prices :</label>
            <input type="text" placeholder="Enter The Book Prices :" name="bookprice" required class="form-control">
            <br>
...
<script>
       function random_number()
       {
           ...
           var n = document.getElementById('bid').value=num;
       }
</script>
</html>
