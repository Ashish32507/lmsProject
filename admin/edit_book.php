<?php
      ...
      $book_no="";
      $book_price="";
      $query = "select * from book where bookid =$_GET[bn]";
?>
...
<div class="row">
    ...
    <?php
        ...
        <form action="" method="post">
            ...
            <input type="text" placeholder="Enter The Book Name :" name="bname" required class="form-control" value="<?php echo $book_name ?>">
            <br>
            <label >Author Name :</label>
            <input type="text" placeholder="Enter The Author name :" name="author" required class="form-control" value="<?php echo $author_id ?>">
           <br>
            <label >Category :</label>
            <input type="text" placeholder="Enter The Category Id :" name="bcat" required class="form-control" value="<?php echo $cat_id ?>">
            <br>
            <label >Book Prices :</label>
            <input type="text" placeholder="Enter The Book Prices :" name="bookprice" required class="form-control" value="<?php echo $book_price?>">
            <br>
...
{
    $connection=mysqli_connect("localhost","root","","lmsproject");
    $query="update book set book_name='$_POST[bname]',author_name='$_POST[author]',cat_name='$_POST[bcat]',book_price='$_POST[bookprice]' where bookid =$_GET[bn]";
    $query_run=mysqli_query($connection,$query);
