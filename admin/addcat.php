...
<div class="row">
    ...
    <div class="col-md-4">
        <form action="" method="post">
                            <label for="stid">Category Id :</label>
                            <input type="number" class="form-control"   name="cid" id="cid" readonly>
                        <br>  
                        
                             <label for="stid">Category Name :</label>
                             <input type="text" class="form-control " placeholder="Enter The Book Name"  name="cname" required >
...
<script>
       function random_number()
       {
           ...
           var n = document.getElementById('cid').value=num;
       }
</script>
</html>
<?php
  ...
  if(isset($_POST['btn']))
   ...
   if($flag==1)
   {?>
      <br><br><center><?php echo "Category Added Sucessfully"; ?></center>  
      <?php 
   }
//    if($flag==0)
//    {
