...
<div class="row">
    ...
    <div class="col-md-4">
        <form action="addauthor.php" method="post">
                            <label for="stid">Author Id :</label>
                            <input type="number" class="form-control"   name="aid" id="aid" readonly>
                        <br>  
                        
                             <label for="stid">Author Name :</label>
                             <input type="text" class="form-control " placeholder="Enter The Author Name :"  name="aname" required >
                        
                         <br>
                               <button type="submit" class="btn btn-primary" name="btn">Add Author</button>
        </form>
    </div>
    <div class="col-md-4"></div>
</div>
...
<script>
       function random_number()
       {
           ...
           var n = document.getElementById('aid').value=num;
       }
</script>
</html>