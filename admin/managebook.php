    ...
    <div class="col-md-8">
        <table class="table table-bordered table-hover " style="text-align:center;">
            ...
            <?php
                   ...
                   <td><Button class="btn" name=""><a href="edit_book.php?bn=<?php echo $row['bookid'];?>">Edit</a></Button><Button class="btn" name=""><a href="delete_book.php?bn=<?php echo $row['bookid'];?>">Delete</a></Button></td>
                   </tr>
                <?php    
                   }
                ?>
