...
<div class="row">
    ...
    <form action="" method="post">
                ...
                ?>
                             ...
                             <input type="text" class="form-control "  name="aname" required value="<?php echo $author_name; ?>" >
...
{
    $connection=mysqli_connect("localhost","root","","lmsproject");
    $query="update author set author_name='$_POST[aname]' where author_id =$_GET[aid]";
    $query_run=mysqli_query($connection,$query);
