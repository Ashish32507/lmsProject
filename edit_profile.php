...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="user_dashboard.php">Lirary Management System</a>
        </div>
...
<div class="row">
    ...
    <div class="col-md-4">
                  <form action="../lmproject/update.php" method="post">
                        <br> 
                            <label for="stid">Student Id :</label>
                            <input type="number" class="form-control" value="<?php echo $stid ?>" >
                        ...
                        <br>
                            ...
                            <input type="email" class="form-control" value="<?php echo $email_id ?>" name="email">
                         ...
                         <br>  
                                ...
                                <textarea id="" cols="40" rows="3" class="form-control" name="address"><?php echo $address ?></textarea>

                         <br>
                                <label for="stid">Branch :</label>
                                <input type="text" class="form-control " value="<?php echo $branch ?>" name="br"> 
                         <br> 
                                <label for="stid">Session :</label>
                                <input type="text" class="form-control" value="<?php echo $session ?>" name="ss">
                         <br>
